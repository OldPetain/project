...
#define PLAYER_JUMP_SPEED 140   // 玩家跳跃速度
#define PLAYER_GRAVITY 15   // 玩家重力加速度

typedef enum { STAND_LEFT, STAND_RIGHT, WALK_LEFT, WALK_RIGHT,  JUMP_LEFT, JUMP_RIGHT, STAND_UP_RIGHT, STAND_UP_LEFT} AnimationState;
